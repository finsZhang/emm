...
<head>
    ...
    <link href="${ctx}/emm/statics/pages/css/index/css/detail.css" rel="stylesheet" type="text/css">
    <script src="${ctx}/emm/statics/pages/index.js?_dc=${staticVersion}"></script>
</head>
<body>
<!--top beign-->
<div class="header clearfix b-blue">
    <h1><a href="javascript:void(0);"> <img src="${ctx}/emm/statics/pages/css/index/images/food_logo.png"
                                            alt="加密机中间件管理系统"></a></h1>
            ...
            <ul class="profile-nav">
                <li class="light-blue">
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li>
                            <a href="${ctx}/emm/ModifyPassword.html">
...
<div class="wrap100 fM_content">
    ...
    <div class="fl l_close" id="left_scroll"><a href="javascript:void(0);"><img
            src="${ctx}/emm/statics/pages/css/index/images/fM-left.png" id="makeleft" onclick="switchBarl()"/></a>
    </div>
    <!--左侧导航 over-->
    <!--右侧内容 begin-->
