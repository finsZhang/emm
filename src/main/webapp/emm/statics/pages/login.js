...
//    }
    ...
    var url =  GLOBAL.WEBROOT+"/emm/statics/common/images/loading.gif";
...
function verifyCode(tab){
    ...
    $.ajax({
        ...
        async: false,
        cache:false,
        url:GLOBAL.WEBROOT +  '/emm/common/checkCode/validate.ajax',
...
function loginBack() {
    ...
    switch (errorCode) {
        ...
        case "0" :
        {
            window.top.location = "/emm/test/test.html";  //测试
            break;
