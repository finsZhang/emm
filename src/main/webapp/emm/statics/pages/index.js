...
$(function () {
	...
	$.ajax({
        ...
        async: false,
		cache:false,
        url:GLOBAL.WEBROOT +  '/emm/getMenus.ajax',
        dataType:'json',
	...
	$.ajax({
		...
		async: false,
		cache:false,
		url:GLOBAL.WEBROOT +  '/emm/getRootOrg.ajax',
		dataType:'json',
		success:function(data){
			initParam(data);
		}
...
function switchBarl(){
	 ...
	 if (imgsrc.indexOf("fM-left.png")>1){  
		 document.all("makeleft").src=GLOBAL.WEBROOT+"/emm/statics/pages/css/index/images/fM-right.png";
...
//		 $("#left_scroll").addClass("fl l_left");
		 ...
		 document.all("makeleft").src=GLOBAL.WEBROOT+"/emm/statics/pages/css/index/images/fM-left.png";
